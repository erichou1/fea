...
from fea_ml_hires.geometry.voxelize import VoxelGrids, voxels_to_mesh
from fea_ml_hires.models.uncertainty import predict_with_uncertainty
from fea_ml_hires.optim.voxel_parameterization import (
...
class VoxelSurrogateOptimizer:
    ...
    def _build_voxel_input(
        ...
        from fea_ml_hires.data.voxel_dataset import NUM_PARTS
